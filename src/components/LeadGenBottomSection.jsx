...
import { useSendContactMessageMutation } from '../Redux/Api'; // adjust path to match your project structure
...
const OfficeAndFooter = () => {
    ...
    const handleEmailSubmit = async (e) => {
        ...
        const payload = {
            ...
            message: `A visitor requested to be contacted. Detail provided: ${value}`,
        };
    ...
    return (
        <div className="w-full bg-[#031430] text-white relative overflow-hidden select-none">
            ...
            <footer
                ...
                className="w-full mt-16 text-[#0A1A3A] pt-32 sm:pt-40 lg:pt-48 pb-6 px-4 sm:px-6 lg:px-12 rounded-t-[30px] sm:rounded-t-[60px] relative z-10 overflow-hidden"
                style={{
            ...
            >
                ...
                <div className="max-w-7xl -mt-16 lg:-mt-36 mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-6 border-b border-slate-200 relative z-10 text-left">
                    ...
                    <div className="md:col-span-3 space-y-4">
                        ...
                        <div className="pt-2">
                            <button
                                ...
                                className="bg-[#FFC700] hover:bg-[#E6B400] mb-4 text-[#031430] font-black text-xs px-5 py-3 rounded-xl shadow-md flex items-center space-x-1.5 transition-transform duration-150 active:scale-95 group cursor-pointer border-none"
                            >
                    ...
                    <div className="md:col-span-4 space-y-3">
                        ...
                        <div className="space-y-1">
                            ...
                            {/* FIX: Restored the complete opening <a> tag element here */}
                            <a
                                href={mapsUrl}
                                target="_blank"
                    ...
                    <div className="md:col-span-5 space-y-4">
                        <h4 className="text-[15px] sm:text-[16px] font-semibold text-black leading-snug">
                            Reach Out To Us
                        </h4>
                        ...
                        <form onSubmit={handleEmailSubmit} className="w-full flex flex-col gap-1 max-w-md">
                            ...
                            {inputError && <p className="text-red-400 text-xs font-medium px-1">{inputError}</p>}
                            {isSuccess && (
                                <p className="text-green-400 text-xs font-medium px-1">Thanks! We'll get in touch shortly.</p>
                            )}
                            {isError && (
                        ...
                        <div className="flex items-center space-x-3 pt-2">
                            {/* FIX: Properly wrapped attributes inside matching <a> element markup tags */}
                            <a
